...
try {
    ...
    DB::table('brouillons')->where('company_id', $companyId)->delete();
    ...
    $totalApproved = DB::table('ecriture_comptables')->where('company_id', $companyId)->where('statut', 'approved')->count();
    echo "Total ecritures: " . $total . " (" . $totalApproved . " approved)\n";

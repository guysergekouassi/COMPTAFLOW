...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top glass-nav py-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="#">
                <span
                    class="avatar avatar-sm bg-primary rounded d-flex align-items-center justify-content-center text-white"
    ...
    <section class="hero-section text-center">
        <div class="container">
            ...
            <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white border text-primary fw-bold mb-4 shadow-sm"
            ...
            <p class="lead text-muted mb-5 mx-auto" style="max-width: 600px;">
                Flow Compta réinvente la gestion comptable pour les cabinets et les entreprises. Centralisez,
                automatisez et analysez vos données en un clic avec l'IA.
            </p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="dashboard-preview-container">
                        <img src="/rapport_img_dashboard.png" alt="Tableau de bord"
                            class="dashboard-preview-img shadow-lg" />
                    </div>
                </div>
            </div>
    ...
    <footer class="footer bg-white border-top py-4 mt-5">
        <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center">
            ...
            <div class="text-muted">
                Support: 07 67 13 19 93 | <a href="mailto:it.dcknowing@gmail.com"
                    class="text-primary">it.dcknowing@gmail.com</a>
            </div>
        </div>
    </footer>

                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="mb-4 d-flex justify-content-end gap-2">
                             ...
                             @if($duplicateCount > 0)
                             <button type="button" class="btn btn-info btn-sm rounded-xl px-4" onclick="exportExistingToExcel()" title="Télécharger la liste des journaux déjà présents en base">
                                    ...
                                    <table class="table table-staging mb-0" style="min-width: 1200px;">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                                ...
                                                <tr class="{{ $row['status'] == 'valid' ? 'row-valid' : ($row['status'] == 'duplicate' ? 'row-warning' : 'row-error') }}" data-status="{{ $row['status'] }}">
    ...
    <script>
        ...
        function buildSearchCache() {
            ...
            rows.forEach(row => {
                ...
                searchCache.push({
                    ...
                    isDuplicate: rowStatus === 'duplicate'
                });
            });
        }
        ...
        function filterTable(type, event) {
            ...
            for (let i = 0; i < searchCache.length; i++) {
                ...
                else if (currentFilter === 'duplicate') statusMatch = item.isDuplicate;

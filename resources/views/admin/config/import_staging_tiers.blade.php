                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex gap-3 h-100">
                                    <div class="bg-slate-50 p-4 rounded-2xl border {{ $statusFilter == 'all' ? 'border-primary active' : 'border-slate-100' }} cursor-pointer card-filter" onclick="window.location.href='{{ request()->fullUrlWithQuery(['status' => 'all', 'page' => 1]) }}'">

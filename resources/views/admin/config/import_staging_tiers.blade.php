                                        ...
                                        <tbody>
                                            ...
                                            @foreach(array_slice($rowsWithStatus, 0, 50) as $rowIndex => $row)
                                                 <tr>
                                                     ...
                                                     <td class="@if($row['status'] == 'error' && empty($row['data']['numero_de_tiers']) && empty($row['data']['auto_num'])) cell-error @endif">
                                                         @if(!empty($row['data']['auto_num']))
                                                              <div class="d-flex align-items-center gap-2">
                                                                  <span class="text-primary font-black @if($row['data']['is_virtual'] ?? false) text-warning opacity-75 @endif">
                                                                      <i class="fa-solid fa-magic me-1"></i> {{ $row['data']['auto_num'] }}
                                                                  </span>
                                                     ...
                                                     <td class="font-mono text-xs @if($row['data']['is_virtual'] ?? false) text-danger @endif">
                                                         {{ $row['data']['compte_general'] ?? '-' }}
                                                         @if($row['data']['is_virtual'] ?? false)

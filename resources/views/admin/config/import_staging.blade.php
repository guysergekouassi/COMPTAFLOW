                                                ...
                                                <tr>
                                                    ...
                                                    @if($import->type == 'initial')
                                                        <td class="@if($row['status'] == 'error') cell-error @endif">
                                                            {{ $row['data'][$mapping['numero_de_compte']] ?? 'N/A' }}
                                                        </td>
                                                        <td>{{ $row['data'][$mapping['intitule']] ?? 'N/A' }}</td>
                                                    @elseif($import->type == 'journals')
                                                        <td class="@if($row['status'] == 'error') cell-error @endif">
                                                            {{ $row['data'][$mapping['code_journal']] ?? 'N/A' }}
                                                        </td>
                                                        <td>{{ $row['data'][$mapping['intitule']] ?? 'N/A' }}</td>
                                                        <td>
                                                            <span class="badge bg-label-info">
                                                                {{ $row['data'][$mapping['type'] ?? 'detected_type'] ?? 'Achats' }}
                                                            </span>
                                                        </td>
                                                        <td>{{ $row['data'][$mapping['compte_de_tresorerie']] ?? '-' }}</td>
                                                        <td>
                                                            <span class="badge {{ !empty($row['data'][$mapping['traitement_analytique'] ?? '']) && strtolower($row['data'][$mapping['traitement_analytique']]) == 'oui' ? 'bg-label-success' : 'bg-label-secondary' }}">
                                                                {{ !empty($row['data'][$mapping['traitement_analytique'] ?? '']) && strtolower($row['data'][$mapping['traitement_analytique']]) == 'oui' ? 'OUI' : 'NON' }}
                                                            </span>
                                                        </td>
                                                        <td>{{ $row['data'][$mapping['rapprochement_sur']] ?? '-' }}</td>
                                                        ...
                                                        <td class="fw-bold">{{ $row['data'][$mapping['intitule']] ?? 'N/A' }}</td>
                                                        <td>
                                                            <span class="badge bg-label-primary">
                                                                {{ $row['data'][$mapping['type_de_tiers']] ?? 'Client' }}
                                                            </span>
                                                        </td>
                                                        <td class="font-mono">{{ $row['data'][$mapping['compte_general'] ?? ''] ?? '-' }}</td>
                                                    @else
                                                        <td>{{ $row['data']['jour'] ?? '-' }}</td>

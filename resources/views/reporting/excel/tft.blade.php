...
@endphp
    @include('reporting.excel.partials.tft_matrix', ['data' => $data, 'exercice' => $exercice, 'visibleMonths' => $visibleMonths, 'detailed' => $detailed])

    @if($cmp)
        <table><tr><td></td></tr></table>
        @include('reporting.excel.partials.tft_matrix', ['data' => $dataN1, 'exercice' => $exerciceN1 ?? $exercice, 'visibleMonths' => $sliceMonths($dataN1['months'] ?? []), 'detailed' => $detailed])
    @endif
</body>
</html>

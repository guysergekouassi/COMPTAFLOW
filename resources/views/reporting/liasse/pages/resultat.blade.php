@php
    function renderResultatRow($ref, $label, $noteCode, $fieldBase, $data, $isTotal = false) {
        ...
        if ($hasDetails && !$isExport) {
            echo "<button class='btn btn-sm btn-light py-0 px-2 text-success border-0 me-2 shadow-none toggle-btn' type='button' data-bs-toggle='collapse' data-bs-target='#detail_{$fieldBase}'>";

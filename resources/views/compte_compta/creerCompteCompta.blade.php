                        ...
                        <div class="modal fade" id="modalCreateComptaAccount" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content premium-modal-content">
                                    ...
                                    {{-- Bouton Google OAuth --}}
                                    <a href="{{ route('google.redirect', 'comptable') }}"
                                       class="btn-google-create w-100 d-flex align-items-center justify-content-center gap-3 mb-4"
                                       style="
                                           background: #fff;
                                       ...
                                       "
                                       onmouseover="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 4px 12px rgba(59,130,246,0.15)'; this.style.transform='translateY(-1px)';"
                                       onmouseout="this.style.borderColor='#e2e8f0'; this.style.boxShadow='0 1px 4px rgba(0,0,0,0.06)'; this.style.transform='translateY(0)';">
                                        ...
                                        Créer l'espace avec Google
                                    </a>

                                    {{-- Séparateur OR --}}
                                    <div class="d-flex align-items-center gap-3 mb-5">
                                        <div style="flex:1; height:1px; background:#e2e8f0;"></div>
                                        <span style="font-size:0.7rem; font-weight:800; color:#94a3b8; text-transform:uppercase; letter-spacing:0.1em; white-space:nowrap;">ou remplir manuellement</span>
                                        <div style="flex:1; height:1px; background:#e2e8f0;"></div>
                                    </div>

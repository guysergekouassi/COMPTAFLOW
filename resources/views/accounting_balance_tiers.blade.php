...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                @include('components.header', ['page_title' => 'Balance des <span class="text-gradient">Tiers</span> <span class="inline-block px-3 py-0.5 text-xs font-bold tracking-widest text-blue-700 uppercase bg-blue-50 rounded-full ml-3">États comptables</span>'])
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="text-center mb-8 -mt-4">
                            <p class="text-slate-500 font-medium max-w-xl mx-auto">
                                Consultation et génération des balances auxiliaires détaillées par tiers.
                            </p>
                        </div>
                                            ...
                                            <tr class="table-row">
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column text-xs">
                                                        <span class="text-slate-500">{{ $balances->updated_at->format('d/m/Y') }}</span>
                                                        <span class="text-slate-400">{{ $balances->updated_at->format('H:i') }}</span>
                                                    </div>
                                                </td>
    ...
    <div class="modal fade" id="modalCenterCreate" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
            <form method="POST" action="{{ route('accounting_balance_tiers.generateBalance') }}" id="grandLivreForm" class="w-100">
                @csrf
                <div class="modal-content premium-modal-content-wide" style="padding: 1.5rem 2rem; max-height: 85vh; display: flex; flex-direction: column; overflow: hidden;">
                    ...
                    <div class="text-center mb-4 position-relative">
                        ...
                        <h1 class="text-xl font-extrabold tracking-tight text-slate-900 mb-2" style="font-size: 1.75rem; font-weight: 800; margin-bottom: 0.5rem;">
                            Générer une <span class="text-blue-gradient-premium">Balance Tiers</span>
                        </h1>
                    ...
                    <div class="flex gap-4 mt-4 pt-3 border-t border-slate-100" style="flex-shrink: 0;">
                        ...
                        <button type="submit" class="btn-action flex-fill justify-center bg-blue-700 text-white shadow-lg shadow-blue-200 hover:bg-blue-800" id="btnSaveModal">
                            <i class="fas fa-check mr-2"></i>Générer La Balance
                        </button>
                    </div>
                </div>
            </form>

    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                @include('components.header', ['page_title' => 'Rapports <span class="text-gradient">Analytiques</span>'])
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y text-center">
                        <div class="glass-card p-12 mt-12">
                            <i class="fa-solid fa-chart-pie text-blue-100 text-9xl mb-6"></i>
                            <h2 class="text-2xl font-bold text-slate-800">Module de Reporting en cours</h2>
                            <p class="text-slate-500 max-w-md mx-auto mt-4">
                                Cette interface (Balance, Grand Livre, Résultat) sera disponible une fois que la saisie analytique aura été intégrée (Étape 4).
                            </p>

            ...
            <div class="row g-6 mb-6">
              ...
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h5 class="mb-0">Journaux de saisi</h5>
                  <div>
                ...
                <div class="collapse px-3 pt-2" id="filterPanel">
                  <div class="row g-2">
                    <div class="col-md-3">
                      <input type="text" id="filter-annee" class="form-control" placeholder="Filtrer par année..." />
                    </div>
                    <div class="col-md-3">
                      <input type="text" id="filter-mois" class="form-control" placeholder="Filtrer par mois..." />
                    </div>
                    <div class="col-md-3">
                      <input type="text" id="filter-code" class="form-control" placeholder="Filtrer par code..." />
                    </div>
                    <div class="col-md-3">
                        ...
                        <td>
                          <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn p-0 border-0 bg-transparent text-primary"
                              data-bs-toggle="modal" data-bs-target="#modalCenterUpdate" data-id="{{ $journal->id }}"
                              data-annee="{{ $journal->annee }}" data-mois="{{ $journal->mois }}"
                              data-code="{{ $journal->code_journal }}" data-type="{{ $journal->type }}"
                            ...
                            <button type="button" class="btn p-0 border-0 bg-transparent text-danger"
                              ...
                              data-id="{{ $journal->id }}" data-name="{{ $journal->code_journal }}">
                      ...
                      <div class="modal-body">
                        <div class="row g-3">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" id="code_journal" name="code_journal" class="form-control" required>
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <select id="traitement_analytique" name="traitement_analytique" class="form-select"
                              required>
                              <option value="">-- Choisir --</option>
                          ...
                          <div class="col-md-6 d-none" id="group_compte_de_contrepartie">
                            <label for="compte_de_contrepartie" class="form-label">Compte de contrepartie</label>
                            <input type="text" id="compte_de_contrepartie" name="compte_de_contrepartie"
                              class="form-control">
                          </div>
                          <div class="col-md-6 d-none" id="group_compte_de_tresorerie">
                            <label for="compte_de_tresorerie" class="form-label">Compte de trésorerie</label>
                            <input type="text" id="compte_de_tresorerie" name="compte_de_tresorerie"
                              class="form-control">
                          </div>
                          <div class="col-md-6 d-none" id="group_rapprochement_sur">
                            <label for="rapprochement_sur" class="form-label">Rapprochement sur</label>
                            <select id="rapprochement_sur" name="rapprochement_sur" class="form-select">
                              <option value="">-- Choisir --</option>
                    ...
                    <form id="formCodeJournalUpdate" method="POST"
                      ...
                      <div class="modal-body">
                        <div class="row g-3">
                          ...
                          <div class="col-md-6">
                            <label for="update_annee" class="form-label">Année *</label>
                            <input type="number" id="update_annee" name="annee" class="form-control" required>
                          </div>
                          <div class="col-md-6">
                            <label for="update_mois" class="form-label">Mois *</label>
                            <select id="update_mois" name="mois" class="form-select" required>
                              <option value="">-- Choisir --</option>
                              @foreach(['01' => 'Janvier', '02' => 'Février', '03' => 'Mars', '04' => 'Avril', '05' =>
                              'Mai', '06' => 'Juin', '07' => 'Juillet', '08' => 'Août', '09' => 'Septembre', '10' =>
                              'Octobre', '11' => 'Novembre', '12' => 'Décembre'] as $val => $label)
                              <option value="{{ $val }}">{{ $label }}</option>
                              @endforeach
                            </select>
                          </div>
                          <div class="col-md-6">
                            <label for="update_code_journal" class="form-label">Code Journal *</label>
                            <input type="text" id="update_code_journal" name="code_journal" class="form-control"
                              required>
                          </div>
                          <div class="col-md-6">
                            <label for="update_intitule" class="form-label">Intitulé *</label>
                            <input type="text" id="update_intitule" name="intitule" class="form-control" required>
                          </div>
                          <div class="col-md-6">
                            <label for="update_traitement_analytique" class="form-label">Traitement analytique *</label>
                            <select id="update_traitement_analytique" name="traitement_analytique" class="form-select"
                              required>
                              <option value="">-- Choisir --</option>
                          ...
                          <div class="col-md-6">
                            ...
                            <select id="update_type" name="type" class="form-select" required>
                              <option value="">-- Choisir --</option>
                              <option value="Achats">Achats</option>
                              <option value="Ventes">Ventes</option>
                              <option value="Tresorerie">Trésorerie</option>
                          ...
                          <div class="col-md-6 d-none" id="update_group_compte_de_contrepartie">
                            <label for="update_compte_de_contrepartie" class="form-label">Compte de contrepartie</label>
                            <input type="text" id="update_compte_de_contrepartie" name="compte_de_contrepartie"
                              class="form-control">
                          </div>
                          <div class="col-md-6 d-none" id="update_group_compte_de_tresorerie">
                            <label for="update_compte_de_tresorerie" class="form-label">Compte de trésorerie</label>
                            <input type="text" id="update_compte_de_tresorerie" name="compte_de_tresorerie"
                              class="form-control">
                          </div>
                          <div class="col-md-6 d-none" id="update_group_rapprochement_sur">
                            <label for="update_rapprochement_sur" class="form-label">Rapprochement sur</label>
                            <select id="update_rapprochement_sur" name="rapprochement_sur" class="form-select">
                              <option value="">-- Choisir --</option>
                              <option value="Contrepartie">Contrepartie</option>
                              <option value="tresorerie">Trésorerie</option>
                            </select>
                ...
                <div class="modal-dialog modal-sm">
                  <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body text-center">
                      <p class="mb-0">
                        Êtes-vous sûr de vouloir supprimer ce journal ? Cette action est <strong>irréversible</strong>.
                      </p>

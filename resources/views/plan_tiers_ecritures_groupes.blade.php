...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        <script>
            const plan_tiers_ecritures_groupesUpdateBaseUrl = "{{ route('plan_tiers_ecritures_groupes.miseAJourMassive') }}";
        </script>

        <script src="{{ asset('js/plan_tiers_ecritures_groupes.js') }}"></script>

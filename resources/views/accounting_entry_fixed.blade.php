<script>
                                                ...
                                                function enregistrerEcritures() {
                                                    ...
                                                    showSuccessMessage('Écritures enregistrées avec succès !');
                                                    
                                                    // Vider le tableau après 2 secondes
                                                    setTimeout(() => {
                                                        tbody.innerHTML = '';
                                                    }, 2000);
                                                }
                                                ...
                                                function modifierEcriture(row) {
                                                    ...
                                                    document.getElementById('description_operation').value = cells[3].textContent;
                                                    document.getElementById('debit').value = cells[7].textContent || '';
                                                    document.getElementById('credit').value = cells[8].textContent || '';
                                                    document.getElementById('reference_piece').value = cells[2].textContent || '';
                                                    
                                                    // Supprimer la ligne après modification
                                                    if (confirm('Modifier cette écriture ? Les données seront chargées dans le formulaire.')) {
                                                        row.remove();
                                                        showSuccessMessage('Écriture chargée pour modification !');
                                                    }
                                                }
                                                ...
                                                function ajouterEcriture() {
                                                    try {
                                                        ...
                                                        actionCell.innerHTML = `
                                                            <button class="btn btn-sm btn-warning me-1" onclick="modifierEcriture(this.closest('tr'));">

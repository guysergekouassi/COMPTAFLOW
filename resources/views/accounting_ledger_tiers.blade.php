...
<body>
                                    ...
                                    <tbody>
                                        @forelse ($grandLivre as $livre)
                                            <tr class="table-row">
                                                ...
                                                <td>
                                                    <span class="px-2.5 py-0.5 rounded-full text-xs font-medium {{ $livre->format == 'pdf' ? 'bg-blue-50 text-blue-700' : 'bg-green-50 text-green-700' }} uppercase tracking-wider">
                                                        {{ $livre->format }}
                                                    </span>
                                                </td>
    ...
    @include('components.apercu_pdf', ['id' => 'modalPreviewPDF', 'frame' => 'pdfPreviewFrame', 'titre' => "Aperçu du grand livre des tiers"])

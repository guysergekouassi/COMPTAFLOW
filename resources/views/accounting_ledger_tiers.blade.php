                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Grand Livre des tiers générés</h5>
                                <div>
                                    ...
                                    <tbody>
                                        @forelse ($grandLivre as $livre)
                                            <tr>
                                                ...
                                                <td>{{ $livre->planTiers1->numero_de_tiers ?? 'N/A' }}
                                                </td>

                                                <td>{{ $livre->planTiers2->numero_de_tiers ?? 'N/A' }}
                                                </td>
                                                <td>
                                                    <button class="btn btn-sm btn-outline-primary btn-preview-pdf"
                                                        ...
                                                        title="Afficher le grand livre des tiers">
                                                        Voir PDF
                                                    </button>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <!-- Téléchargement -->
                                                        <a href="{{ asset('grand_livres_tiers/' . $livre->grand_livre_tiers) }}"
                        ...
                        <div class="modal fade" id="modalCenterCreate" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <form method="POST" action="{{ route('accounting_ledger_tiers.generateGrandLivre') }}"
                                    id="grandLivreForm">
                                    @csrf
